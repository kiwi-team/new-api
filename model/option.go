...
type ModelParamsFilterMap struct {
	...
	SetTemperatureOne  *[]string         `json:"set_temperature_one,omitempty"`  // o系列模型，不再支持temperature这个参数
	...
	SetTopPZero        *[]string         `json:"set_top_p_zero,omitempty"`       // openai的模型，建议都设置成0
...
func InitOptionMap() {
	...
	common.OptionMap["RegisterUidCheckEnabled"] = strconv.FormatBool(common.RegisterUidCheckEnabled)
	...
	common.OptionMap["TieredPrice"] = ratio_setting.TieredPrice2JSONString()
...
func updateOptionMap(key string, value string) (err error) {
	...
	if strings.HasSuffix(key, "Enabled") || key == "DefaultCollapseSidebar" || key == "DefaultUseAutoGroup" {
		...
		case "RegisterUidCheckEnabled":
			common.RegisterUidCheckEnabled = boolValue
	...
	case "TieredPrice":
		err = ratio_setting.UpdateTieredPriceByJSONString(value)
	case "CacheRatio":
