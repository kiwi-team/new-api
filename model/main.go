...
//				if !isLog {
//					common.UsingMainDatabase(common.DatabaseTypePostgreSQL) = true
//				} else {
...
func migrateClickHouseLogDB() error {
	...
	if err := LOG_DB.Exec("ALTER TABLE logs ADD COLUMN IF NOT EXISTS race_result String DEFAULT ''").Error; err != nil {
		return err
	}
