...
type User struct {
	...
	Uid                  string                     `json:"uid" gorm:"type:varchar(200);index;default:''"`
	RelatedUids          string                     `json:"related_uids" gorm:"type:text"`
...
// GetUserByIdIncludeDeleted returns a user by ID, including soft-deleted rows.
