...
func UpdateUser(c *gin.Context) {
	...
	if originUser.Quota != updatedUser.Quota {
		model.RecordLog(originUser.Id, model.LogTypeManage, fmt.Sprintf("管理员将用户额度从 %s修改为 %s", logger.LogQuota(originUser.Quota), logger.LogQuota(updatedUser.Quota)), updatedUser.Quota)
	}
	c.JSON(http.StatusOK, gin.H{
		"success": true,
		"message": "",
