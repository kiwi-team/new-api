...
export function ChannelMutateDrawer({
  ...
  const requestPolicyFields = (
    <div
      role='group'
      aria-label={t('Request path and response rules')}
      className={channelConfigurationBlockClassName(
        configuration.blocks.requestPolicy,
        'flex flex-col gap-4'
      )}
    >
      <CardHeading
        title={t('Request path and response rules')}
        status={configuration.blocks.requestPolicy}
      ...
      >
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel>{t('Model output mapping')}</FormLabel>
              <FormControl>
                <Textarea
                  rows={3}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Textarea rows={3} placeholder='/v1/messages' {...field} />
                </FormControl>
                <FormDescription>
                  {t(
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Textarea rows={3} placeholder='/v1/embeddings' {...field} />
                </FormControl>
                <FormDescription>
                  {t(
            ...
            {currentType === 41 && (
              <>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>{t('Google file bucket')}</FormLabel>
                      <FormControl>
