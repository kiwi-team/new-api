        ...
        >
          <Form.Section text={t('日志设置')}>
            <Row gutter={16}>
              ...
              <Col xs={24} sm={12} md={8} lg={8} xl={8}>
                <Form.Switch
                  field={'LogHeaderRedactEnabled'}
                  label={t(
                    '日志请求头脱敏（Authorization/Cookie/X-Api-Key 等替换为 ***末4位）',
                  )}
                  size='default'
                  checkedText='｜'
                  uncheckedText='〇'
                ...
                >
                  {t(
                    '关闭后 logs/error_logs.header 列会原样保存所有请求头，包括 token，谨慎开启',
                  )}
                </Text>
              </Col>
              <Col xs={24} sm={12} md={8} lg={8} xl={8}>
