...
// https://api.ppinfra.com/v3/async/hunyuan-image-3
type HunyuanImage3TaskSubmitRequest struct {
	// 提示词
...
func (a *TaskAdaptor) BuildRequestURL(info *relaycommon.RelayInfo) (string, error) {
	return "https://api.ppinfra.com/v3/async/hunyuan-image-3", nil
}
...
func (a *TaskAdaptor) BuildRequestBody(c *gin.Context, info *relaycommon.RelayInfo) (io.Reader, error) {
	...
	body := HunyuanImage3TaskSubmitRequest{
		Model:  req.Model,
		Prompt: req.Prompt,
		Size:   req.Size,
		Seed:   -1,
...
func (a *TaskAdaptor) GetChannelName() string { return "ppio-hunyuan-image-3" }
