...
const (
	ErrorTypeNewAPIError     ErrorType = "toio_api_error"
...
const (
	...
	// channel error
	ErrorCodeChannelGetError              ErrorCode = "channel:get_channel_error"
	...
	ErrorCodeChannelClaudeCodeGuardReject ErrorCode = "channel:claude_code_guard_rejected"
	...
	// task error
	ErrorCodeGetTaskResultFailed  ErrorCode = "get_task_result_failed"
	ErrorCodeGetTaskResultTimeout ErrorCode = "get_task_result_timeout"
